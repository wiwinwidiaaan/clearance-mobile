...
export default function RegisterScreen({ navigation }) {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.subtitle}>Gratis, cuma butuh satu menit.</Text>
...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: "#E4D9C4", padding: 24, justifyContent: "center" },
  ...
  label: { fontSize: 13, fontWeight: "600", color: "#1F1B16", marginBottom: 6, marginTop: 12 },
  input: {
    borderWidth: 1.5,
    borderColor: "#1F1B16",
  ...
  switchText: { textAlign: "center", marginTop: 16, color: "#C23B22", fontWeight: "600" }
});
